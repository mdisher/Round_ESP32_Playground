...
Five swipeable pages are rendered into a 240×240 sprite and pushed to the display at up to 50 Hz, with per-second redraws on clock pages and NTP-synchronised time.
...
| IMU | QMI8658 6-axis, I2C (present, not yet used) |
...
| 4 | Diagnostics | WiFi RSSI, SSID, IP, MAC, NTP status, heap, PSRAM, uptime, battery voltage |
...
| `page_diagnostics.h` | Diagnostics page |
